    ...
    private fun handleDownloadedFile(downloadId: Long) {
        ...
        if (cursor.moveToFirst()) {
            ...
            if (status == DownloadManager.STATUS_SUCCESSFUL) {
                    ...
                    var originalFileName = "schedule_${System.currentTimeMillis()}.xls"
                    ...
                    try {
                        ...
                        if (sourceUri == null) {
                            ...
                            if (filenameColumnIndex != -1) {
                                ...
                                if (!filename.isNullOrEmpty()) {
                                    ...
                                    originalFileName = java.io.File(filename).name
                                }
                            }
                        }
                        ...
                        // 尝试从COLUMN_TITLE获取文件名
                        if (originalFileName.startsWith("schedule_")) {
